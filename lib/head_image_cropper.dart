...
const Color _defualtGridColor = Color.fromARGB(160, 255, 255, 255);
...
class CropperImage extends RenderObjectWidget {
  CropperImage(
    ...
    this.isGrid = false,
    this.gridColor = _defualtGridColor,
    this.gridWidth = 1,
  ...
  /// 是否显示直角修饰  默认值：false
  final bool isRightAngle;

  /// 是否显示九宫格 默认值：false
  final bool isGrid;

  ///  gridColor 九宫格线条颜色 默认值：#00000080
  final Color gridColor;

  ///  gridWidth 九宫格线宽 默认值：1
...
class CropperImageRender extends RenderProxyBox {
  ...
  bool isGrid = false;
  Color gridColor = Color.fromARGB(160, 255, 255, 255);
  double gridWidth = 1;
    ...
    if (isArc) {
      ...
      if (isGrid) {
        ...
        canvas.drawPath(
            Path()
              ..addPolygon([
                Offset(left! + (right! - left!) / 3, top!),
                Offset(left! + (right! - left!) / 3, bottom!),
              ], false),
            Paint()
              ..color = gridColor
        ...
        canvas.drawPath(
            Path()
              ..addPolygon([
                Offset(left! + (right! - left!) / 3 * 2, top!),
                Offset(left! + (right! - left!) / 3 * 2, bottom!),
              ], false),
            Paint()
              ..color = gridColor
              ..strokeWidth = gridWidth
        ...
        canvas.drawPath(
            Path()
              ..addPolygon([
                Offset(left!, top! + (bottom! - top!) / 3),
                Offset(right!, top! + (bottom! - top!) / 3!),
              ], false),
            Paint()
              ..color = gridColor
              ..strokeWidth = gridWidth
        ...
        canvas.drawPath(
            Path()
              ..addPolygon([
                Offset(left!, top! + (bottom! - top!) / 3 * 2),
                Offset(right!, top! + (bottom! - top!) / 3 * 2!),
              ], false),
            Paint()
              ..color = gridColor
              ..strokeWidth = gridWidth
      ...
      if (isRightAngle) {
        ...
        canvas.drawPath(
            Path()
              ..addPolygon([
                Offset(left! - lineWidth, top! + 16),
                Offset(left! - lineWidth, top! - lineWidth),
                Offset(left! + 16, top! - lineWidth),
              ], false),
            Paint()
              ..color = lineColor
              ..strokeWidth = 3
        ...
        canvas.drawPath(
            Path()
              ..addPolygon([
                Offset(right! - 16, top! - lineWidth),
                Offset(right! + lineWidth, top! - lineWidth),
                Offset(right! + lineWidth, top! + 16),
              ], false),
            Paint()
              ..color = lineColor
              ..strokeWidth = 3
        ...
        canvas.drawPath(
            Path()
              ..addPolygon([
                Offset(right! + lineWidth, bottom! - 16),
                Offset(right! + lineWidth, bottom! + lineWidth),
                Offset(right! - 16, bottom! + lineWidth),
              ], false),
            Paint()
              ..color = lineColor
              ..strokeWidth = 3
        ...
        canvas.drawPath(
            Path()
              ..addPolygon([
                Offset(left! + 16, bottom! + lineWidth),
                Offset(left! - lineWidth, bottom! + lineWidth),
                Offset(left! - lineWidth, bottom! - 16),
              ], false),
            Paint()
              ..color = lineColor
              ..strokeWidth = 3
